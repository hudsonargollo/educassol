...
const FEATURE_PILLARS: FeaturePillar[] = [
  {
    id: 'magic-planner',
    headline: 'Planejamento Inteligente',
    copy: 'Selecione o tema e a série. Veja a IA gerar um plano de aula completo com objetivos, metodologia e materiais em segundos.',
    icon: CalendarDays,
    gradient: 'orange',
  },
  {
    id: 'instant-activity',
    headline: 'Atividades Instantâneas',
    copy: 'Não apenas planeje — crie! Gere automaticamente fichas de exercícios, apresentações e textos de leitura alinhados à sua aula.',
    icon: Wand2,
    gradient: 'teal',
  },
  {
    id: 'differentiation',
    headline: 'Personalização Total',
    copy: 'Um clique para adaptar, enriquecer ou traduzir qualquer recurso. Garanta que cada aluno acesse o mesmo currículo de qualidade.',
    icon: Users,
    gradient: 'purple',
  },
  {
    id: 'bncc-aligned',
    headline: 'Alinhado à BNCC',
    copy: 'Todos os conteúdos são gerados seguindo as competências e habilidades da Base Nacional Comum Curricular.',
    icon: FileText,
    gradient: 'blue',
  },
  {
    id: 'ai-powered',
    headline: 'IA de Última Geração',
    copy: 'Powered by Gemini Pro. Contexto inteligente que entende pedagogia brasileira e adapta o conteúdo ao seu estilo.',
    icon: Brain,
    gradient: 'amber',
  },
  {
    id: 'fast-generation',
    headline: 'Velocidade Incrível',
    copy: 'O que levava horas agora leva segundos. Economize até 15 horas por semana em planejamento e preparação de aulas.',
    icon: Zap,
    gradient: 'green',
  },
];
